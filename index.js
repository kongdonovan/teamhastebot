...
const fs = require('fs');
const { token, prefix, status, statusType } = require('./config.json');

// Object initializations
const client = new Client({ intents: [Intents.FLAGS.GUILDS, Intents.FLAGS.GUILD_MESSAGES, Intents.FLAGS.GUILD_VOICE_STATES], presence: {status: "dnd", activities: [{name: status + " | " + prefix + "help", type: statusType || 3}]}, partials: ['MESSAGE', 'CHANNEL', 'REACTION'] });
